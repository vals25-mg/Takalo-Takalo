...
<head>
    ...
    <!-- ................CUSTOM CSS LINK................... -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/accueil_client.css') ?>">
</head>
<body>
    <!-- .............START NAV SECTION...................... -->
    <nav>
        <div class="container nav-container">
            <h2 class="logo">
                Takalo<span>Takalo</span>
            </h2>
            <div class="search-bar">
                <img src="icon/search.svg" class="icon2">
                <input type="search" placeholder="search for creater...">
            </div>
            <div class="create">
                <label for="creatPost" class="btn btn-primary" >update</label>
                <div class="profile-phots">
                    <img src="<?php echo base_url('Images/profile-1.jpeg') ?>" alt="">
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="container main-container">
            ...
            <div class="main-left">
              ...
              <div class="side-bar"> 
                ...
                <a class="menu-item " >
                    <span><img src="icon/joystick.svg" class="icon1"></span><h3>explore</h3>
                </a>
                <a class="menu-item" id="notifice">
                    <span> <small class="count">9</small> <img src="icon/bell.svg" class="icon1"></span><h3>notifications</h3>
                    <!-- ....................notification............................ -->
                ...
                <a class="menu-item " >
                    ...
                    <span><img src="icon/graph-up-arrow.svg" class="icon1"></span><h3>analytics</h3>
                </a>
                <a class="menu-item " id="themeMenu">
                    <span><img src="icon/palette.svg" class="icon1"></span><h3>theme</h3>
                </a>
                <a class="menu-item g" href="<?php echo base_url('index.php/welcome/deconnect')?>" >
                    <span><img src="icon/gear.svg" class="icon1"></span><h3>Deconnecter</h3>
                </a>   
